from psychopy import visual, sound, data, event, core
...
class Experiment:
    ...
    def __init__(self, subject, sex, age, block, block_num):
        self.num_trials = 1
        self.system_id = 0
        self.yes = 'g'
        self.no = 'h'
        ...
        self.win = visual.Window(fullscr=False, color='black', units='pix', screen=self.system_id)
...
if __name__ == '__main__':
    ...
    age = sys.argv[2]
    sex = sys.argv[3]
    block_name = sys.argv[4]
    block_num = sys.argv[5]
    block = Experiment(subj, age, sex, block_name, block_num)
    block.run()